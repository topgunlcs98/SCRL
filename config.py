...
class Config(object):
    def __init__(self, config_file):
        ...
        self.it = conf.getint("Model_Setup", "it")
        self.seed = conf.getint("Model_Setup", "seed")
        self.alpha = conf.getfloat("Model_Setup", "alpha")
        self.temperature1 = conf.getfloat("Model_Setup", "temperature1")
        self.temperature2 = conf.getfloat("Model_Setup", "temperature2")
        self.nmb_pro = conf.getint("Model_Setup", "nmb_pro")
